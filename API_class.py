...
class APIcall():
    ...
    def __call__(self, input_file_name = None, output_file_name = None, user_prmpt = "", read_input_file = False, make_json = False, print_llm_response = False):
